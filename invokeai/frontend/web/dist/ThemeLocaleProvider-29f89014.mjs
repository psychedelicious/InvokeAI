import { j as y, eA as Ie, eB as mt, eC as gt, Q as qr, eD as o, eE as b, eF as v, eG as S, eH as Nr, eI as ht, eJ as pt, ez as yt, eK as St, s as xt, eL as $t, eM as kt, ac as _t, ab as wt } from "./exports-bb43e98f.mjs";
import { useState as sr, useMemo as Ae, useCallback as dr, useEffect as Ke, createContext as Gr, useContext as Ct, useRef as zt } from "react";
import { T as At, a as Pt } from "./chunk-ZP4IHIHZ-46707b0e.mjs";
import "react-dom";
var Ur = `
  :root {
    --chakra-vh: 100vh;
...
var Yo = (e) => Object.keys(e).length === 0, _ = (e, r, t) => {
  ...
  const t = _(r, e);
  return Ko(t) < 128 ? "dark" : "light";
}, Jo = (e) => (r) => Xo(e)(r) === "dark", Z = (e, r) => (t) => {
  const a = _(t, e);
  return No(a, 1 - r);
};
...
var Qo = () => `#${Math.floor(Math.random() * 16777215).toString(16).padEnd(6, "0")}`;
function Zo(e) {
  const r = Qo();
...
var Be = (e, ...r) => r.map(Qr).join(` ${e} `).replace(/calc/g, ""), mr = (...e) => `calc(${Be("+", ...e)})`, gr = (...e) => `calc(${Be("-", ...e)})`, Xe = (...e) => `calc(${Be("*", ...e)})`, hr = (...e) => `calc(${Be("/", ...e)})`, pr = (e) => {
  const r = Qr(e);
...
var { defineMultiStyleConfig: da, definePartsStyle: _e } = b(Po.keys), ie = x("switch-track-width"), q = x("switch-track-height"), De = x("switch-track-diff"), ca = E.subtract(ie, q), Je = x("switch-thumb-x"), re = x("switch-bg"), ba = o((e) => {
  ...
  borderRadius: "sm",
  fontWeight: "bold"
}), K = v("badge-bg"), B = v("badge-color"), Wa = o((e) => {
...
}), { definePartsStyle: D, defineMultiStyleConfig: Ja } = b(po.keys), Qa = D({
  field: {
    width: "100%",
    minWidth: 0,
    outline: 0,
...
var { definePartsStyle: we, defineMultiStyleConfig: $n } = b(vo.keys), se = v("checkbox-size"), kn = o((e) => {
  ...
  baseStyle: Ti
}), { defineMultiStyleConfig: Ii, definePartsStyle: Qe } = b(xo.keys), Bi = o({
  bg: "blackAlpha.600",
  zIndex: "modal"
}), Mi = o((e) => {
...
var Xi = {
  ...
  baseStyle: bl
}), { definePartsStyle: Ze, defineMultiStyleConfig: vl } = b(fo.keys), Ge = v("drawer-bg"), Ue = v("drawer-box-shadow");
function U(e) {
  return Ze(e === "full" ? {
...
var fl = o({
  ...
  baseStyle: Pl
}), { definePartsStyle: Fl, defineMultiStyleConfig: Il } = b(go.keys), X = v("form-control-color"), Bl = o({
  marginStart: "1",
  ...
  baseStyle: El
}), { definePartsStyle: jl, defineMultiStyleConfig: Rl } = b(ho.keys), J = v("form-error-color"), Wl = o({
...
}), { defineMultiStyleConfig: Yl, definePartsStyle: Kl } = b(uo.keys), Xl = o({
  transitionProperty: "common",
  transitionDuration: "fast",
  transitionTimingFunction: "ease-out",
  cursor: "pointer",
...
var js = ve((e) => {
...
}), { definePartsStyle: lt, defineMultiStyleConfig: Os } = b(bo.keys), Q = v("avatar-border-color"), Ye = v("avatar-bg"), qs = o({
  borderRadius: "full",
  border: "0.2em solid",
  [Q.variable]: "white",
  _dark: {
  ...
  const { name: r, theme: t } = e, a = r ? Zo({ string: r }) : "colors.gray.400", n = Jo(a)(t);
  let i = "white";
  return n || (i = "gray.800"), {
    bg: Or.reference,
    "&:not([data-loaded])": {
...
}), { defineMultiStyleConfig: Kd, definePartsStyle: Xd } = b(gd.keys), Jd = o({
  bg: "blackAlpha.600"
}), Qd = o({}), Zd = o((e) => ({
  bg: "base.850",
  maxH: "80vh"
...
}), { defineMultiStyleConfig: Kc, definePartsStyle: Xc } = b($d.keys), Jc = o((e) => {
  const { colorScheme: r } = e;
  return {
    bg: "base.600",
    _focusVisible: {
